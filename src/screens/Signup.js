        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              ...
              <input type="email" placeholder='Enter email Address' className="form-control" name='email' value={credentials.email} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
            ...
            <div className="m-3">
              <button type="button" onClick={handleClick} name="geolocation" className=" btn btn-success text-white">Click for current Location </button>
            </div>
            <div className="m-3">
